...
//! `PVM_BINARY_parachain-authorizer-ed25519` env var (consumed by `pvm_binary!` in
...
fn main() {
	pvm_builder::build_authorizer(parachain_authorizer_ed25519::MANIFEST_DIR.as_ref());
}
